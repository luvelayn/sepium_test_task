export const initCarousel = (cardEl, data) => {
    ...
    const options = {
        Autoplay: false,
        Arrows: {
            prevTpl: "<svg width=\"19\" height=\"19\"><use xlink:href=\"/images/sprite.svg#left-arrow\"></use></svg>",
            nextTpl: "<svg width=\"19\" height=\"19\"><use xlink:href=\"/images/sprite.svg#right-arrow\"></use></svg>",
        },
        breakpoints: {
            "(max-width: 768px)": {
                Autoplay: {
